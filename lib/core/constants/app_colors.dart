...
class AppColors {
  ...
  static const Color redPastel      = Color(0xFFF2A5A5); // Stabilo Pastel cerise givrée
  ...
  static const List<Color> palette100 = [
    ...
    // Row 7 – Pastel doux
    redPastelDoux, pinkPastelDoux, violetPastelDoux, bluePastelDoux, cyanPastelDoux,
    greenPastelDoux, limePastelDoux, yellowPastelDoux, orangePastelDoux, neutralPastelDoux,
